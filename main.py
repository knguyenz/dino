...
def start_screen():
    selected_option = 0  # 0 for "Start Game", 1 for "High Score"
    font = pygame.font.Font('freesansbold.ttf', 30)
    ...
    while run:
        ...
        title_text = font.render("RUN GAME", True, (0, 0, 0) if selected_option == 0 else (100, 100, 100))
        title_rect = title_text.get_rect()
        title_rect.center = (SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 - 50)
        SCREEN.blit(title_text, title_rect)

        high_score_text = font.render("VIEW HIGH SCORE", True, (0, 0, 0) if selected_option == 1 else (100, 100, 100))
        high_score_rect = high_score_text.get_rect()
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_UP or event.key == pygame.K_DOWN:
                    selected_option = (selected_option + 1) % 2  # Toggle option
...
def view_high_score():
    ...
    while run:
        ...
        back_text = font.render("Press ESC to go back", True, (0, 0, 0))
        back_rect = back_text.get_rect()
        back_rect.center = (SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 + 50)
